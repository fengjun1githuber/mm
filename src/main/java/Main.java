import handler.ConferenceArrangeHandler;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        List<Talk> events = generateTalks("input.txt");
    ...
    private static List<Talk> generateTalks(String testDataFilePath) {
        return readLines(testDataFilePath).stream()
                .map(Main::getSingleTalk)
